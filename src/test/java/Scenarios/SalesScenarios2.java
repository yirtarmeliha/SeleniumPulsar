...
public class SalesScenarios2 extends OpenPage{
    ...
    void ScenarioTwo() {
        ...
        Elements.MixandMacthcurrentRecordName().sendKeys("AVOCADO 2 for £1.00");
        ...
        Elements.MixandMacthcurrentRecordName().sendKeys("AVOCADO 2 for £1.10");
        ...
        Elements.MixandMacthcurrentRewardAmount().sendKeys("£1.10");
        ...
        Elements.MixandMacthcurrentRecordName().sendKeys("AVOCADO 3 for £1.50");
        ...
        Elements.MixandMacthcurrentRewardAmount().sendKeys("£1.50");
        ...
        assertEquals("£1.50", Elements.basketDiscountTD().getAttribute("innerHTML"),"The discount price in the basket does not match.");
        assertEquals("£3.50", Elements.basketSubtotalTD().getAttribute("innerHTML"),"The total price in the basket does not match.");
        ...
        assertEquals("07", Elements.keypadModalClass().getAttribute("value"),"The numbers entered on the keyboard screen that opens do not match.");
